...
export type FetchCurrentUserIdQuery = { __typename: 'Query', viewer: { __typename: 'User', id: string } };
...
export type FetchReleasesQuery = { __typename: 'Query', repository: { __typename: 'Repository', refs: { __typename: 'RefConnection', nodes: Array<{ __typename: 'Ref', id: string, name: string, target: { __typename: 'Blob' } | { __typename: 'Commit', oid: any, pushedDate: any | null | undefined, committedDate: any, deployments: { __typename: 'DeploymentConnection', nodes: Array<{ __typename: 'Deployment', id: string, createdAt: any, environment: string | null | undefined, state: DeploymentState | null | undefined, latestStatus: { __typename: 'DeploymentStatus', createdAt: any } | null | undefined } | null | undefined> | null | undefined, pageInfo: { __typename: 'PageInfo', endCursor: string | null | undefined, hasNextPage: boolean } } | null | undefined } | { __typename: 'Tag' } | { __typename: 'Tree' } | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined };

export type CommitFragmentFragment = { __typename: 'Commit', oid: any, pushedDate: any | null | undefined, committedDate: any, deployments: { __typename: 'DeploymentConnection', nodes: Array<{ __typename: 'Deployment', id: string, createdAt: any, environment: string | null | undefined, state: DeploymentState | null | undefined, latestStatus: { __typename: 'DeploymentStatus', createdAt: any } | null | undefined } | null | undefined> | null | undefined, pageInfo: { __typename: 'PageInfo', endCursor: string | null | undefined, hasNextPage: boolean } } | null | undefined };

export type DeployFragment = { __typename: 'Deployment', id: string, createdAt: any, environment: string | null | undefined, state: DeploymentState | null | undefined, latestStatus: { __typename: 'DeploymentStatus', createdAt: any } | null | undefined };
...
export type FetchReposWithWriteAccessQuery = { __typename: 'Query', viewer: { __typename: 'User', repositories: { __typename: 'RepositoryConnection', totalCount: number, nodes: Array<{ __typename: 'Repository', id: string, name: string, owner: { __typename: 'Organization', login: string } | { __typename: 'User', login: string }, defaultBranchRef: { __typename: 'Ref', name: string } | null | undefined } | null | undefined> | null | undefined, pageInfo: { __typename: 'PageInfo', endCursor: string | null | undefined, hasNextPage: boolean } } } };

export type RepoFragment = { __typename: 'Repository', id: string, name: string, owner: { __typename: 'Organization', login: string } | { __typename: 'User', login: string }, defaultBranchRef: { __typename: 'Ref', name: string } | null | undefined };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    fetchReleases(variables: FetchReleasesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchReleasesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchReleasesQuery>(FetchReleasesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'fetchReleases');
    },
    fetchReposWithWriteAccess(variables?: FetchReposWithWriteAccessQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchReposWithWriteAccessQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchReposWithWriteAccessQuery>(FetchReposWithWriteAccessDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'fetchReposWithWriteAccess');
    }
  };
}
