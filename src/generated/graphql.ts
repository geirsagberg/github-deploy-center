  ...
  & { viewer: (
    ...
    & { repositories: (
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          { __typename?: 'Repository' }
          & Pick<Repository, 'id' | 'nameWithOwner'>
        )> }
      )>>>, pageInfo: (
        { __typename?: 'PageInfo' }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchUser(variables: FetchUserQueryVariables): Promise<FetchUserQuery> {
      return withWrapper(() => client.request<FetchUserQuery>(print(FetchUserDocument), variables));
    },
