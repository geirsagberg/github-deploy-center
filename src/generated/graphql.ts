...
export type Discussion = Comment & Updatable & Deletable & Lockable & RepositoryNode & Subscribable & Reactable & Votable & Node & {
...
export type FetchCurrentUserIdQuery = (
  { __typename: 'Query' }
  & { viewer: (
    { __typename: 'User' }
    & Pick<User, 'id'>
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchDeployments(variables: FetchDeploymentsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchDeploymentsQuery> {
      return withWrapper(() => client.request<FetchDeploymentsQuery>(FetchDeploymentsDocument, variables, requestHeaders));
    },
    fetchCurrentUserId(variables?: FetchCurrentUserIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchCurrentUserIdQuery> {
      return withWrapper(() => client.request<FetchCurrentUserIdQuery>(FetchCurrentUserIdDocument, variables, requestHeaders));
    },
    fetchReleases(variables: FetchReleasesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchReleasesQuery> {
      return withWrapper(() => client.request<FetchReleasesQuery>(FetchReleasesDocument, variables, requestHeaders));
    },
    fetchReposWithWriteAccess(variables?: FetchReposWithWriteAccessQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FetchReposWithWriteAccessQuery> {
      return withWrapper(() => client.request<FetchReposWithWriteAccessQuery>(FetchReposWithWriteAccessDocument, variables, requestHeaders));
    }
  };
}
